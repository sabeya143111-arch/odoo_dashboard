...
# ─────────────────────────────────────────────────────────────────────────────
# PDF INVOICE PARSING (ONLY ADDITION)
# ─────────────────────────────────────────────────────────────────────────────
...
def show_dashboard() -> None:
    ...
    # Manual search (with FIXED banner syntax)
    ...
    # Comparison logic (PDF support + original logic)
    if compare_btn or 'pdf_codes_to_search' in st.session_state:
        if 'pdf_codes_to_search' in st.session_state and st.session_state.get('pdf_codes_to_search'):
